wget https://downloads.sourceforge.net/project/zero-install/0install/2.14.1/0install-linux-x86_64-2.14.1.tar.bz2
tar xjf 0install-linux-x86_64-2.14.1.tar.bz2
cd 0install-linux-x86_64-2.14.1
./install.sh home
